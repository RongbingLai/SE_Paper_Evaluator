...
section_title_list = fetch_all_section_titles(
    "/Users/crystalalice/Desktop/ICSHP_Research/SE_paper/Software_Documentation_Issues_Unveiled.pdf"
)
...
section_content = fetch_section_content_by_titles(
...
print(
    generate_review(
        section_content, "research result: Is the result concrete and specific?"
    )
)
